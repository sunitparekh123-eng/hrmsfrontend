      ...
      <div style={{ marginTop: 60, display: 'flex', justifyContent: 'space-between' }}>
        <div>
          {signatory?.signature_url ? (
            ...
            <div style={{ width: 130, borderTop: '2px solid #0f172a', marginBottom: 8 }} />
          )}
      ...
      <div style={{ marginTop: 56, display: 'flex', gap: 60 }}>
        <div>
          {signatory?.signature_url ? (
            ...
            <div style={{ width: 120, borderBottom: '2px solid #0f172a', marginBottom: 6 }} />
          )}
      ...
      <div style={{ marginTop: 60, display: 'flex', justifyContent: 'space-between' }}>
        <div style={{ textAlign: 'center' }}>
          {signatory?.signature_url ? (
            ...
            <div style={{ width: 130, borderTop: '1px solid #0f172a', marginBottom: 6, margin: '0 auto' }} />
          )}
        ...
        <div style={{ textAlign: 'center', opacity: 0.3 }}>
          <div style={{ width: 130, borderTop: '1px solid #0f172a', marginBottom: 6 }} />
