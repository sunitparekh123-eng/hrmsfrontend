...
const mockTransactions = [
    { id: "EMP001", name: "Arjun Singh", role: "Senior Developer", branch: "Indore Hub", base: 120000, bonus: 5000, pf: 1800, pt: 200, net: 123000, status: "Transferred" },
    { id: "EMP002", name: "Meera Das", role: "Product Manager", branch: "Bhopal Unit", base: 85000, bonus: 0, pf: 1800, pt: 200, net: 83000, status: "Transferred" },
    { id: "EMP003", name: "Rahul Sharma", role: "UI/UX Designer", branch: "Indore Hub", base: 95000, bonus: 2000, pf: 1800, pt: 200, net: 95000, status: "Transferred" },
    { id: "EMP004", name: "Anita Kapoor", role: "HR Head", branch: "Satna Node", base: 115000, bonus: 0, pf: 1800, pt: 200, net: 113000, status: "Transferred" },
    { id: "EMP005", name: "Vikram Raj", role: "Backend Lead", branch: "Indore Hub", base: 140000, bonus: 10000, pf: 1800, pt: 200, net: 148000, status: "Transferred" },
    { id: "EMP006", name: "Priya Singh", role: "QA Engineer", branch: "Bhopal Unit", base: 75000, bonus: 0, pf: 1800, pt: 200, net: 73000, status: "Pending" },
    { id: "EMP007", name: "Rajesh Kumar", role: "DevOps Engineer", branch: "Satna Node", base: 105000, bonus: 5000, pf: 1800, pt: 200, net: 108000, status: "Transferred" },
    { id: "EMP008", name: "Neha Gupta", role: "Marketing Exec", branch: "Bhopal Unit", base: 65000, bonus: 0, pf: 1800, pt: 200, net: 63000, status: "Transferred" },
];

export default function CycleDetailsPage({ params }: { params: Promise<{ id: string }> }) {
    const resolvedParams = use(params);
    const cycleId = resolvedParams.id; // e.g. APR-2026
    
    const [searchQuery, setSearchQuery] = useState("");
    const [selectedBranch, setSelectedBranch] = useState("All Branches");

    const branches = ["All Branches", "Indore Hub", "Bhopal Unit", "Satna Node", "Mumbai HQ"];
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 px-2 pt-4">
                    <div>
                        ...
                        <h1 className="text-3xl font-black text-slate-900 italic uppercase tracking-tighter flex items-center gap-4">
                            Cycle Audit <span className="text-indigo-500 underline underline-offset-8 decoration-[#D9F99D] decoration-4">{cycleId}</span>
                        </h1>
